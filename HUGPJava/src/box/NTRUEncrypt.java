...
public class NTRUEncrypt {
	...
	private static Polynomial tt = null;
	...
	public static KeyPair generateKeyPair() {
		...
		Polynomial f = null, fp = null, fq = null, t = null;
		...
		fp = Polynomial.scalarAsPoly(1, N);
		...
		PrivKey priv = new PrivKey(fq, g, fp);
	...
	public static Polynomial decrypt(Polynomial cip, PrivKey priv) {
		Polynomial a = tt.times(cip).mod(Q);
		a.times(3);
		a.add(cip);
		a.center(Q);
		a.mod(3);
